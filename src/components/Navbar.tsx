      ...
      >
        ...
        hover:scale-105 active:scale-95 transition-all duration-300"
            ...
            <div className="relative group">
              <button
                className="px-6 py-3 rounded-xl bg-gradient-to-r from-[#375DB9] to-[#7ED6F4] 
        ...
        <div
          ref={mobileMenuRef}
          className={`lg:hidden absolute top-full left-0 right-0 bg-white/80 backdrop-blur-lg border-b border-primary/50 shadow-lg ${isMobileMenuOpen ? "block" : "hidden"
            }`}
        >
            ...
            <div className="flex flex-col space-y-4">
              ...
              {NAVLINKS.map((link) => (
                <Link
                  ...
                  className={`text-black hover:text-black transition-all duration-300 py-2 text-lg ${pathname === link.path
